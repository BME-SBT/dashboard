...
class MotorControllerTemperatureWidget(AbstractPanelElement):
    def __init__(self):
        super().__init__(title='CTRL TMP', sensor_id=SensorId.MOTOR_CONTROLLER_TEMPERATURE.value)
        ...
        # Panel
        self.bar_widget = BarWidget(70, 270, [-10, 0, 40, 65, 85], [Colors.BLUE, Colors.GREEN, Colors.ORANGE, Colors.RED], self.sensor.data_type.unit, self.title, False, 1)
