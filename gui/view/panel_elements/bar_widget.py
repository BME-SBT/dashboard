...
class BarWidget(AbstractGaugeWidget):
    ...
    def draw_gauge(self):
        ...
        if self.isVertical:
            ...
            for i in range(len(self.tresholds) - 1, 0, -1):
                ...
                color = self.normal_colors[i - 1].value
            ...
            painter.drawText(QRect(x,y,self.value_text_width, self.value_text_height), Qt.AlignCenter, str(self.name))
            ...
            for i in range (0, len(self.tresholds) - 1):
                ...
                color = self.normal_colors[i].value
                # painter.drawRect(x, y, width, height)
                painter.fillRect(x, y, width, height, color)
            ...
            y = 3 * self.padding + self.bar_width + text_height
            ...
            painter.drawText(QRect(x,y, 2* self.value_text_width, self.value_text_height), Qt.AlignLeft|Qt.AlignTop, str(self.name))
    ...
    def paintEvent(self, event):
        ...
        if self.isVertical:
            ...
            painter.drawText(QRect(0,y,self.value_text_width, self.value_text_height), Qt.AlignCenter, str(self.value))
        else:
            width = 5
            ...
            painter.scale(1, -1)
            painter.fillRect(x, y, width, height, self.text_color.value)
            painter.drawText(QRect(0, self.padding, self.value_text_width, self.value_text_height), Qt.AlignCenter, str(self.value))
        painter.end()
        self.canvas_label.setPixmap(canvas)
