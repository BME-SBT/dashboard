...
def build_sensor_array():
    ...
    SensorManager.add_sensor(
        Sensor(SensorId.MOTOR_CONTROLLER_TEMPERATURE.value,  data.data_types.TEMPERATURE, "motor_controller_temperature", 10))
    SensorManager.add_sensor(
    ...
    SensorManager.add_sensor(
        Sensor(SensorId.TELEMETRYBOX_AIR_TEMPERATURE.value,  data.data_types.TEMPERATURE, "telemetrybox_air_temperature", 1))
    SensorManager.add_sensor(
    ...
    SensorManager.add_sensor(
        Sensor(SensorId.ERROR_THROTTLE_POSITION.value,  data.data_types.THROTTLE_POSITION, "error_throttle_position", 100))
    SensorManager.add_sensor(
        Sensor(SensorId.ERROR_DEAD_MANS_SWITCH_POSITION.value,  data.data_types.SWITCH_POSITION, "error_dead_mans_switch_position", 10))
    SensorManager.add_sensor(
        Sensor(SensorId.ERROR_MOTOR_SWITCH_POSITION.value,  data.data_types.SWITCH_POSITION, "error_motor_switch_position", 10))
